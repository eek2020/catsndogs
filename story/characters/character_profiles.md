...
| Leadership | 6 | Crew morale and fleet command |
| Negotiation | 4 | Prefers cunning to diplomacy |
| Combat Skill | 5 | Capable but not his strength |
| Intimidation | 6 | Reputation carries weight |
| Stealth | 7 | Operates from the shadows when needed |
...
## Dave — Dual Protagonist / Antagonist

- **Species:** Dog — Canis League commander
- **Faction:** Canis League
- **Role:** Playable protagonist (when selected) or primary antagonist (when playing as Aristotle). Leading the dog faction's campaign to break the crystal monopoly.
...
| Stat | Value | Notes |
| ------ | ------- | ------- |
| Cunning | 4 | Methodical, not tricky |
| Leadership | 8 | Commands deep loyalty |
| Negotiation | 6 | Direct but effective |
| Combat Skill | 7 | Strong military commander |
| Intimidation | 5 | Quiet authority |
...
### Death — Secondary Antagonist Behaviour State Progression
