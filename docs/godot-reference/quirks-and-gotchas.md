# Godot Engine Quirks and Gotchas

Known engine issues, type inference errors, and runtime pitfalls for Godot 4.6 development. Compiled from the godogen project's accumulated knowledge.
